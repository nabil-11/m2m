        ...
        <Card.ImgOverlay className="card-overlay">
          {
            ...
            <Row style={{textAlign:"center",marginTop:"20%"}}><Col md={8} className="m-auto"><p className="prixZone">{props.product.pPrice -props.product.pPrice*props.product.pSold /100} TND</p></Col></Row>
